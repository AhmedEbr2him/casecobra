...
const OrderRecivedEmail = ({
    ...
    const baseUrl =
        process.env.NODE_ENV === 'development'
            ? 'http://localhost:3000'
            : 'https://casecobra-phi-six.vercel.app';
    return (
        <Html>
            <Head />
            ...
            <Body style={main}>
                <Container style={container}>
                    ...
                    <Hr style={global.hr} />
                    <Section style={global.defaultPadding}>
                        <Row style={{ display: 'inline-flex', marginBottom: 48 }}>
                    ...
                    <Section style={global.paddingY}>
                        <Row>
                            ...
                            >
                                Please contect us if you have any questions. (If you reply to this
                                email, we won't bel able to read it.)
                            </Text>
                        </Row>
                        <Row>
                            <Text style={footer.text}>
                                &copy; CaseCobar, Inc. All Rights Reserved.
                            </Text>
                        </Row>
                    </Section>
                </Container>
